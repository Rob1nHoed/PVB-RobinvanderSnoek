    ...
    <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
        <div class=" overflow-hidden sm:rounded-lg flex justify-center">
            <div class="flex justify-center pt-10 px-2">
                <button wire:click="previousResultPage" class="bg-blue-500 hover:bg-blue-700 text-white text-2xl font-bold py-1 px-4 rounded w-48">
                    Previous page
                </button>
            </div>
            <div class="flex justify-center pt-10 px-2">
                <button wire:click="nextResultPage" class="bg-blue-500 hover:bg-blue-700 text-white text-2xl font-bold py-1 px-4 rounded w-48">
                    Next page
                </button>
            </div>
        </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <div class="grid grid-cols-4 gap-4">
                    @foreach ($paginatedDrinks as $drink)
